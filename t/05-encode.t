...
eval {
    @uchar = snmp_object({
                 value => { oid => '1.2.3', type => 'INTEGER', value => 1234567890 },
             });
    ...
    is_deeply(\@uchar, [115,116,114,105,110,103,32,99,111,110,116,97,105,110,105,110,103,32,112,101,114,99,101,110,116,58,32,37], 'string() encoded') or diag "@uchar";
