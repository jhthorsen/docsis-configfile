...
our $TREE = {
  ...
  DsServiceFlow => {
    ...
    nested => {
      ...
      DsVendorSpecific    => {
        ...
        lsize      => 1,
        limit      => [0, 0],
        vendorspec => {VendorIdentifier => {code => 8, func => "hexstr", lsize => 1, limit => [3, 3]},},
      },
  ...
  UsServiceFlow => {
    ...
    nested => {
      ...
      UsVendorSpecific     => {code => 43, func => "vendorspec", lsize => 1, limit => [0, 0], vendorspec => {},},
    },
  },
  VendorSpecific => {code => 43, func => "vendorspec", lsize => 1, limit => [0, 0], vendorspec => {},},
};
